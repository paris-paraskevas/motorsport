  ...
  return (
    <div ref={wrapRef} className="relative flex items-center">
      <button
        ...
        className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-full bg-text text-bg hover:bg-text-muted p-1.5 transition-colors duration-(--duration-fast)"
      >
        <Bell size={15} />
      </button>
