    ...
    <div className={`flex items-center gap-1.5 ${className}`}>
      ...
      {isLoaded && isSignedIn && isStaff && (
        <Link
          ...
          className="hidden lg:inline-flex items-center justify-center gap-1.5 min-h-11 min-w-11 text-xs font-bold text-black bg-brand hover:bg-brand-deep rounded-full px-3 py-1.5 transition-colors duration-(--duration-fast)"
        >
      ...
      {isLoaded && isSignedIn && (
        <Link
          ...
          className="hidden lg:inline-flex items-center justify-center gap-1.5 min-h-11 min-w-11 text-xs font-bold text-black bg-brand hover:bg-brand-deep rounded-full pl-1 pr-3 py-1 transition-colors duration-(--duration-fast)"
        >
          {user?.imageUrl ? (
            <>
