  ...
  return (
    <div className="mx-auto max-w-2xl lg:max-w-4xl p-4 pb-16 md:p-6 lg:p-8">
      ...
      <nav className="mb-5 flex gap-5 border-b border-white/10 font-mono text-[11px] uppercase tracking-[0.16em]">
        <Link href="/social/friends" className="-mb-px border-b-2 border-transparent pb-2 text-text-muted hover:text-text">
          Friends
        </Link>
        <Link href="/social/leagues" className="-mb-px border-b-2 border-brand pb-2 text-text">
          Leagues
        </Link>
      </nav>
      {children}
  ...
  if (!userId) {
    return frame(
      <div className="font-mono text-sm text-text-muted">
        <p className="mb-3">Sign in to create and join leagues.</p>
