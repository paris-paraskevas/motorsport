...
// Route-segment error boundary for the whole app tree. Next App Router requires
// this to be a Client Component ({ error, reset }); matches the voice + surface
// of the existing app/(app)/error.tsx so a fault outside that group still lands
// on-brand instead of the raw framework fallback.
      ...
      <div className="relative overflow-hidden rounded-3xl border border-border bg-surface/60 p-10 md:p-14">
        ...
        <div className="relative">
          ...
          <p className="text-text-muted text-base leading-relaxed max-w-md">
            Hit an error loading this page. We&apos;ve logged it. Try again, or
            head back to the grid.
          </p>
